...
# Script to run examples on an interactive node on Satori. For better
# performance, get exclusive access to the onde. READ ALL
# INSTRUCTIONS!!

# Set JOB_NAME used for this script
JOB_NAME=example_Satori_interactive
